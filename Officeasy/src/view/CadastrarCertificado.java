...
public class CadastrarCertificado extends JDialog {
	...
	public CadastrarCertificado(List<Certificado> list) {
		...
		table.getColumn("Descrição").setPreferredWidth(120);
		...
		btnConcluir.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				CadastrarFuncionario.setCert(listaTabela);
				dispose();
