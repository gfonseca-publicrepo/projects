...
public class ModificarDependente extends JDialog {
	...
	public ModificarDependente(List<Dependente> list) {
		...
		tableDependentes = new JTable(tableModel) {// CRIANDO TABELA COM MODELO
			private static final long serialVersionUID = 1L;

			// ATUALIZA TABELA QUANDO HÀ ALTERAÇÂO
		...
		btnConcluir.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				ModificarFuncionario.setDep(dependentes);
				dispose();
			}
		});
