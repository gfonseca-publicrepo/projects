...
public class ModificarFuncionario extends JFrame {
	...
	public ModificarFuncionario(Funcionario usu, Funcionario f) {
		...
		beneficio = f.getBeneficios();
		dependentes = f.getDependentes();
		try {
			certificados = f.getDocumentos().getCertificados();
		...
		if (f.getStatus()) {
			...
			boxSituacao.setSelectedItem("Desligado");
		}
		...
		JLabel lblNewLabel = new JLabel("Nome da Mãe");
		painel8.add(lblNewLabel);
		...
		JFormattedTextField textAgencia = new JFormattedTextField();
		...
		gl_panels.setHorizontalGroup(gl_panels.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panels.createSequentialGroup()
						.addGroup(gl_panels.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(gl_panels.createSequentialGroup().addGap(147).addComponent(lblMatricula)
										.addPreferredGap(ComponentPlacement.RELATED)
										.addComponent(textMatricula, GroupLayout.PREFERRED_SIZE,
												GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
										.addGap(4).addComponent(lblSituacao).addPreferredGap(ComponentPlacement.RELATED)
										.addComponent(boxSituacao, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
												GroupLayout.PREFERRED_SIZE))
		...
		gl_panels.setVerticalGroup(gl_panels.createParallelGroup(Alignment.LEADING)
				.addGroup(
						gl_panels.createSequentialGroup().addGap(11)
								.addGroup(gl_panels.createParallelGroup(Alignment.BASELINE)
										.addComponent(lblFichaDeFuncionrio).addComponent(btnCancelar))
								.addPreferredGap(ComponentPlacement.RELATED)
								.addGroup(gl_panels.createParallelGroup(Alignment.BASELINE)
										.addComponent(textMatricula, GroupLayout.PREFERRED_SIZE,
												GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
										.addComponent(lblMatricula).addComponent(lblSituacao).addComponent(boxSituacao,
												GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
												GroupLayout.PREFERRED_SIZE))
								.addPreferredGap(ComponentPlacement.RELATED)
								.addComponent(painel1, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addGap(7)
								.addComponent(painel2, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addGap(6)
								.addComponent(painel3, GroupLayout.PREFERRED_SIZE, 33, GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(ComponentPlacement.RELATED)
								.addComponent(painel17, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(ComponentPlacement.RELATED)
								.addComponent(painel5, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addGap(6)
								.addComponent(painel18, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addGap(6)
								.addComponent(painel7, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addGap(6)
								.addComponent(painel8, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addGap(6)
								.addComponent(painel9, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addGap(6)
								.addComponent(painel10, GroupLayout.PREFERRED_SIZE, 32, GroupLayout.PREFERRED_SIZE)
								.addGap(6)
		...
		try {
			...
			dateAdmissao.setDate(f.getDados().getDtAdmissao());
			dateASO.setDate(f.getDocumentos().getAso());
			textMatricula.setText(String.valueOf(f.getMatricula()));
			textLogradouro.setText(f.getEndFun().getLogradouro());
			textNumero.setText(String.valueOf(f.getEndFun().getNumero()));
			textCep.setText(f.getEndFun().getCep());
			textPai.setText(f.getDocumentos().getPai());
			textMae.setText(f.getDocumentos().getMae());
			textRG.setText(f.getDocumentos().getRg());
			textEmissorRG.setText(f.getDocumentos().getOrgaoEmissor());
			dateEmissaoRG.setDate(f.getDocumentos().getDtEmissao());
			boxBancos.setSelectedItem(f.getDadosBanco().getBanco().getNomeBanco());
			boxTipoConta.setSelectedItem(f.getDadosBanco().getTpConta().getTipo());
			textTelefone.setText(f.getDados().getTelefone());
			textCelular.setText(f.getDados().getCelular());
			boxLocais.setSelectedItem(f.getLocal().getNome());
			boxContrato.setSelectedItem(f.getContrato().getNome());
			textBairro.setText(f.getEndFun().getBairro());
			textCidade.setText(f.getEndFun().getCidade());
			textConta.setText(f.getDadosBanco().getNumeroConta());
			textAgencia.setText(f.getDadosBanco().getAgencia());
			boxEstadoCivil.setSelectedItem(f.getDados().getEstadoCivil());
			boxSexo.setSelectedItem(f.getDados().getSexo());
			textEmail.setText(f.getDados().getEmail());
			textComplemento.setText(f.getEndFun().getComplemento());
			textCPF.setText(f.getDocumentos().getCpf());
			textCTPS.setText(f.getDocumentos().getCtps());
			textPIS.setText(f.getDocumentos().getPis());
			textNomeCompleto.setText(f.getNome());
			textCargo.setText(f.getCargo());
			dateNascimento.setDate(f.getDados().getDtNascimento());
			textJornada.setText(String.valueOf(f.getDados().getCargaH()));
			textSalario.setText(String.valueOf(f.getDados().getSalario()));
			boxUF.setSelectedItem(f.getEndFun().getEstado());
		...
		btnBeneficios.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				new ModificarBeneficio(beneficio);
		...
		btnDependentes.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				new ModificarDependente(dependentes);
		...
		btnCertificados.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				new ModificarCertificado(certificados);
